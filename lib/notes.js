...
function getDefaultNotes() {
  return [
    { id: 1, title: '프로젝트 기획서', body: '노트 앱 기획\n\nNext.js 기반으로 제작할 예정입니다.', locked: false, password: null, color: '#276FBF', tagId: null, pinned: false, date: '오늘' },
    { id: 2, title: '비밀 노트', body: '이것은 비밀 노트입니다.', locked: true, password: '1234', color: '#4CAF82', tagId: null, pinned: false, date: '어제' },
    { id: 3, title: '독서 메모', body: '원씽 — 단 하나의 가장 중요한 일에 집중하라', locked: false, password: null, color: '#E97C5A', tagId: null, pinned: false, date: '3일 전' },
    { id: 4, title: '아이디어 노트', body: '떠오르는 아이디어들\n\n- AI 요약 기능', locked: false, password: null, color: '#A07BE0', tagId: null, pinned: false, date: '1주 전' },
    { id: 5, title: '오늘 할 일', body: 'Next.js 셋업\n컴포넌트 설계\nUI 기획 완성', locked: false, password: null, color: '#F5B731', tagId: null, pinned: false, date: '오늘' },
  ]
}
